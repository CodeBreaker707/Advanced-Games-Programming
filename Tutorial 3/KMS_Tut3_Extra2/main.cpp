...
// POS for Position and COL for Color
...
{
	{ XMFLOAT3(-0.5f, -0.5f, 0.0f), XMFLOAT4(0.4f, 0.2f, 0.5f, 1.0f) },
	{ XMFLOAT3(-0.5f, 0.5f, 0.0f), XMFLOAT4(0.4f, 0.2f, 0.5f, 1.0f) },
	{ XMFLOAT3(0.5f, 0.5f, 0.0f), XMFLOAT4(0.4f, 0.2f, 0.5f, 1.0f) },	
	{ XMFLOAT3(-0.5f, -0.5f, 0.0f), XMFLOAT4(0.4f, 0.2f, 0.5f, 1.0f) },
	{ XMFLOAT3(0.5f, -0.5f, 0.0f), XMFLOAT4(0.4f, 0.2f, 0.5f, 1.0f) },
...
char		g_Tutorial_03_Extra_02[100] = "Tutorial 03 Extra 02\0";
...
HRESULT InitialiseWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(Manikandan, g_Tutorial_03_Extra_02, WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		if (wParam == VK_LEFT)
		{
			vertices[0].Pos.x -= 0.05;
			vertices[1].Pos.x -= 0.05;
			vertices[2].Pos.x -= 0.05;
		}
		if (wParam == VK_UP)
		{
			vertices[0].Pos.y += 0.05;
			vertices[1].Pos.y += 0.05;
			vertices[2].Pos.y += 0.05;
		}
		if (wParam == VK_RIGHT)
		{
			vertices[0].Pos.x += 0.05;
...
HRESULT InitialiseGraphics()// 03-01
{
	...
	bufferDesc.ByteWidth = sizeof(POS_COL_VERTEX) * 6; // Total size of buffer, 6 vertices
