...
char		g_Tutorial_06_Extra_01[100] = "Tutorial 06 Extra 01\0";
...
HRESULT InitialiseWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(Manikandan, g_Tutorial_06_Extra_01, WS_OVERLAPPEDWINDOW,
...
void RenderFrame(void)
{
	...
	projection = XMMatrixPerspectiveFovLH(XMConvertToRadians(45.0), 1280.0 / 768.0, 0.0001, 100.0);
