...
POS_COL_VERTEX L_vertices[] =
{
	...
	{ XMFLOAT3(-1.0f, -1.0f, -1.0f),    XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-1.0f, 1.0f, -1.0f),     XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -1.0f) ,     XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-1.0f, -1.0f, -1.0f),    XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -1.0f),      XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),     XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	...
	// right vertical face
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),     XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -1.0f),     XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	...
	{ XMFLOAT3(-1.0f, -1.0f, -1.0f), XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),    XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-1.0f, -1.0f, -0.5f),      XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),     XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	...
	// top vertical face
	{ XMFLOAT3(-1.0f, 1.0f, -1.0f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-1.0f, 1.0f, -0.5f),  XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -0.5f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-1.0f, 1.0f, -1.0f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -0.5f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, 1.0f, -1.0f),    XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },

	//**************************************************************//
	//**********************HORIZONTAL PIECE************************//
	//**************************************************************//

	// back horizontal face
	{ XMFLOAT3(0.25f, -1.0f, -0.5f),      XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },
	...
	{ XMFLOAT3(0.25f, -0.5f, -1.0f) ,     XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),    XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -1.0f),      XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -1.0f),     XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },

	// right horizontal face
	{ XMFLOAT3(0.25f, -1.0f, -1.0f),     XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -1.0f),     XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -0.5f),      XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -1.0f),      XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -0.5f),      XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -0.5f),      XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },

	// bottom horizontal face
	{ XMFLOAT3(-0.5f, -1.0f, -0.5f),     XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -1.0f),     XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -1.0f),    XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(-0.5f, -1.0f, -0.5f),      XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -1.0f),     XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -1.0f, -0.5f),   XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f) },
	...
	{ XMFLOAT3(-0.5f, -0.5f, -1.0f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -0.5f),     XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	{ XMFLOAT3(0.25f, -0.5f, -1.0f),    XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
};
...
char		g_Tutorial_06_Extra_02[100] = "Tutorial 06 Extra 02\0";
...
HRESULT InitialiseWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(Manikandan, g_Tutorial_06_Extra_02, WS_OVERLAPPEDWINDOW,
...
HRESULT InitialiseGraphics()// 03-01
{
	...
	bufferDesc.ByteWidth = sizeof(L_vertices); // Total size of buffer, number of vertices
	...
	// Copy the data
	memcpy(ms.pData, L_vertices, sizeof(L_vertices));
